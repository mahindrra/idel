...
class ObjectivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create objective" do
    assert_difference('Objective.count') do
      post objectives_url, params: { objective: { course_id: @objective.course_id, name: @objective.name } }
    end
  ...
  test "should update objective" do
    patch objective_url(@objective), params: { objective: { course_id: @objective.course_id, name: @objective.name } }
